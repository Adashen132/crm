...
<script type="text/javascript">
	...
	$(function(){
		...
		//其他文件由html改成jsp，有可能把workbench去了
		window.open("workbench/main/index.jsp","workareaFrame");//头部加了东西，相对路径失效，全部使用绝对路径
			...
			<ul>
				<li class="dropdown user-dropdown">
					<a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle" data-toggle="dropdown">
						<span class="glyphicon glyphicon-user"></span>${sessionScope.user.name}<span class="caret"></span><!--带Scope的可以省略，剩下user.name-->
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</a>
